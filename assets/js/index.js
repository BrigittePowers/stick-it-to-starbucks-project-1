...
//Add the zip search to search history//
...
function loadLastZip() {
    $("ul").empty();
    var zCode = JSON.parse(localStorage.getItem("zipcode"));
    if (zCode!==null){
        zCode=JSON.parse(localStorage.getItem("zipcode"));
